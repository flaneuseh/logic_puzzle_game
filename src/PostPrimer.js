...
export default ResponseRecorded = ({goToNextPuzzle, isProlific}) => {
    ...
    if(!finish){
        return (<div className="recorded">
            ...
            <p>If you found this puzzle particularly challenging or did not enjoy it, feel free to exit now. You are also welcome to attempt the other puzzles. {isProlific? "You will be bonus paid $2.50 for each additional post-puzzle survey you complete.": ""} </p>
